    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-3 sm:p-4">
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[95vh] overflow-y-auto">
        ...
        <div className="relative p-4 sm:p-6 border-b border-gray-200">
          <button
            onClick={onClose}
            className="absolute top-3 right-3 sm:top-4 sm:right-4 p-2 hover:bg-gray-100 rounded-full transition-colors duration-200"
          >
          ...
          <div className="text-center pr-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Opgrader til Pro</h2>
          ...
          <div className="text-center">
            <div className="flex items-center justify-center space-x-2 mb-2">
              ...
              <div className="text-left">
                <div className="text-base sm:text-lg font-semibold text-gray-900">kr</div>
        ...
        <div className="p-4 sm:p-6">
          <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4">Hvad får du med Pro?</h3>
